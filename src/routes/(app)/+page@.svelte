...
<!-- This route escapes the (app) layout (the `@` in the filename) so the
     marketing landing can render as a normal scrolling page with its own
     header. The dashboard opts back into the in-app frame here. -->
{#if hasData}
  <AppShell>
